...
EMAIL_USE_TLS = str(os.getenv('EMAIL_USE_TLS', '')).lower() in ('1', 'true', 'yes')
EMAIL_USE_SSL = str(os.getenv('EMAIL_USE_SSL', '')).lower() in ('1', 'true', 'yes')
# TLS and SSL are mutually exclusive in Django; prefer TLS (Gmail port 587).
if EMAIL_USE_TLS:
    EMAIL_USE_SSL = False
